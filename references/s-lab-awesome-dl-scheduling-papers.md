# S-Lab Awesome DL Scheduling Papers (Mirror)

Source repository: [S-Lab-System-Group/Awesome-DL-Scheduling-Papers](https://github.com/S-Lab-System-Group/Awesome-DL-Scheduling-Papers)

This file mirrors the upstream README as a local reference snapshot added on 2026-06-26. Future updates can either keep this file as a snapshot or replace it with a cleaner personally curated version.
